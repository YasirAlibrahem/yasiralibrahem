...
useEffect(() => {
  ...
  return (
    <div>
        <Link to={`/posts/MentalModelsToCultiavte`}>
          <img src={process.env.PUBLIC_URL + '/cover-balanced-mind.png'} alt="Post Cover" style={{borderRadius: '5%', width: '100%', height: '50%'}} />
        </Link>
        <br />
...
export default MentalModelsToCultiavte;